...
public class RPSLSpock {
    ...
    /**
     * Checks to see if users input is a valid pick.
     * @param pick the users pick
     * @return boolean true if the users pick is valid, false if it is not valid
     */
    ...
    /**
     * Computer generates and returns random pick.
     ...
     * @param c_pick Computers random pick
     * @param h_pick Users valid pick
     * @return boolean true computer won, false the user won.
     */
